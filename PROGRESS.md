...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v291 — quest town turn-in |
| **Active branch** | `main` |
| **CI gate** | v291 focused gates green on 2026-06-19 (`make validate-shared`, `go test ./internal/game -run 'QuestTurnIn\|MainConfig\|Interactable'`, `test_item_visuals.gd`, `test_quest_giver_visual.gd`, `bot scenario=97_quest_town_turn_in`, `bot-client scenario=75_quest_town_turn_in`, `make maintainability`); selected-batch `make ci` attempted and red on non-v291 gates |
| **Next slice** | v292 — TBD after selected `$autoloop` queue |
