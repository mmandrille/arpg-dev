...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v287 — second boss template |
| **Active branch** | `main` |
| **CI gate** | v287 focused gates green on 2026-06-19 (`cd server && go test ./internal/game -run 'TestBoss'`, `validate-shared`, `bot scenario=second_boss_template`, `make maintainability`); full autoloop-batch `make ci` pending after selected queue |
| **Next slice** | v288 — market notification badge |
