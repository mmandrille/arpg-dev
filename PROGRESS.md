...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v260 — biome color palettes |
| **Active branch** | `main` |
| **CI gate** | v260 focused verification green on 2026-06-18; autoloop batch `make ci` pending |
| **Next slice** | Continue selected `$autoloop` queue with generated door obstacles |
...
| Dungeon generation | Rivers/water obstacles, generated doors in obstacle walls, doorway/high-obstacle/non-rectangular fog line-of-sight blocking beyond current rectangular wall server/client occlusion, full room/corridor PCG, rotated/polygon/destructible/secret obstacles, boss-floor obstacle generation, final biome/difficulty balance beyond first area-density formulas | v40/v252/v253/v254/v255/v260 non-goals |
