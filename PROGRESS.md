...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v247 — mercenary combat stats |
| **Active branch** | `main` |
| **CI gate** | Focused v247 checks green on 2026-06-17; selected v241-v250 `$autoloop` batch `make ci` pending |
| **Next slice** | v248 — ranged threats hit companions |
