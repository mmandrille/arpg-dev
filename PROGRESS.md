...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v262 — doorway LOS occlusion |
| **Active branch** | `main` |
| **CI gate** | v262 focused verification green on 2026-06-18; autoloop batch `make ci` pending |
| **Next slice** | Continue selected `$autoloop` queue with quest path minimap marker |
