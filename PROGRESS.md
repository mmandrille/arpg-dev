...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v299 — obstacle variety pack |
| **Active branch** | `codex/world-detail-navigation` |
| **CI gate** | v299 focused autoloop gates green on 2026-06-19: `make validate-shared`, focused Go obstacle variety/collision/flying/Leap tests, `TestDungeonObstaclesGolden`, `obstacle_variety_pack` protocol bot via direct script, `make client-unit`, `obstacle_variety_pack` headless client bot via direct script, and `make maintainability`; final batch `make ci` pending |
| **Next slice** | v300 — line-of-sight blockers from the selected World Detail/Navigation queue |
...
| Dungeon generation | High-obstacle/non-rectangular fog line-of-sight blocking beyond current rectangular wall and closed-door occlusion, full room/corridor PCG, rotated/polygon/destructible/secret obstacles, boss-floor obstacle generation, final biome/difficulty balance beyond first area-density formulas | v40/v252/v253/v254/v255/v260/v261/v262/v295/v296/v297/v298/v299 non-goals |
