...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v249 — boss reward panel |
| **Active branch** | `main` |
| **CI gate** | Focused v249 checks green on 2026-06-17; selected v241-v250 `$autoloop` batch `make ci` pending |
| **Next slice** | v250 — boss-specific telegraph decals |
