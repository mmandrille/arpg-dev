...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v246 — blacksmith upgrade history |
| **Active branch** | `main` |
| **CI gate** | Focused v246 checks green on 2026-06-17; selected v241-v250 `$autoloop` batch `make ci` pending |
| **Next slice** | v247 — mercenary combat stats |
