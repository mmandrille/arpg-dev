...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v296 — hazard holes / chasms |
| **Active branch** | `codex/world-detail-navigation` |
| **CI gate** | v296 focused autoloop gates green on 2026-06-19: `make validate-shared`, focused Go obstacle/path/fog tests, `TestDungeonObstaclesGolden`, `reachable_dungeon_obstacles` protocol bot via direct script, `make client-unit`, `dungeon_wall_rendering` headless client bot via direct script, and `make maintainability`; final batch `make ci` pending |
| **Next slice** | v297 — flying navigation trait from the selected World Detail/Navigation queue |
...
| Dungeon generation | Flying navigation exceptions, barbarian leap over marked obstacles, obstacle variety, high-obstacle/non-rectangular fog line-of-sight blocking beyond current rectangular wall and closed-door occlusion, full room/corridor PCG, rotated/polygon/destructible/secret obstacles, boss-floor obstacle generation, final biome/difficulty balance beyond first area-density formulas | v40/v252/v253/v254/v255/v260/v261/v262/v295/v296 non-goals |
