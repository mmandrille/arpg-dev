...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v297 — flying navigation trait |
| **Active branch** | `codex/world-detail-navigation` |
| **CI gate** | v297 focused autoloop gates green on 2026-06-19: `make validate-shared`, focused Go navigation/path tests, `flying_navigation_trait` protocol bot via direct script, `make client-unit`, `flying_navigation_trait` headless client bot via direct script, and `make maintainability`; final batch `make ci` pending |
| **Next slice** | v298 — barbarian leap over gaps/water from the selected World Detail/Navigation queue |
...
| Dungeon generation | Barbarian leap over marked obstacles, obstacle variety, high-obstacle/non-rectangular fog line-of-sight blocking beyond current rectangular wall and closed-door occlusion, full room/corridor PCG, rotated/polygon/destructible/secret obstacles, boss-floor obstacle generation, final biome/difficulty balance beyond first area-density formulas | v40/v252/v253/v254/v255/v260/v261/v262/v295/v296/v297 non-goals |
