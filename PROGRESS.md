...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v298 — barbarian leap obstacle crossing |
| **Active branch** | `codex/world-detail-navigation` |
| **CI gate** | v298 focused autoloop gates green on 2026-06-19: `make validate-shared`, focused Go Leap/mobility/path tests, `barbarian_leap_obstacle_crossing` protocol bot via direct script, `make client-unit`, `barbarian_leap_obstacle_crossing` headless client bot via direct script, and `make maintainability`; final batch `make ci` pending |
| **Next slice** | v299 — obstacle variety pack from the selected World Detail/Navigation queue |
...
| Dungeon generation | Obstacle variety, high-obstacle/non-rectangular fog line-of-sight blocking beyond current rectangular wall and closed-door occlusion, full room/corridor PCG, rotated/polygon/destructible/secret obstacles, boss-floor obstacle generation, final biome/difficulty balance beyond first area-density formulas | v40/v252/v253/v254/v255/v260/v261/v262/v295/v296/v297/v298 non-goals |
