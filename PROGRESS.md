...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v248 — ranged threats hit companions |
| **Active branch** | `main` |
| **CI gate** | Focused v248 checks green on 2026-06-17; selected v241-v250 `$autoloop` batch `make ci` pending |
| **Next slice** | v249 — boss reward panel |
