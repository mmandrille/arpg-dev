...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v263 — quest path minimap marker |
| **Active branch** | `main` |
| **CI gate** | v257-v263 `$autoloop` batch `make ci` green on 2026-06-18 |
| **Next slice** | Selected `$autoloop` queue complete; run engineering review/refactor before more features |
...
| Client presentation | Boss portraits, multi-boss layouts, exact authoritative boss countdown sync, production shape-specific telegraph decals/VFX/audio, production boss health bar art/audio, production dungeon fog lighting/art pass beyond code-native radial/LOS masks, minimap routefinding/click-to-navigate/legend/filter UI, draggable titlebar migration for waypoint/menu windows, reset-layout UI, server/account-synced UI layout | v53/v57/v58/v73/v74/v75/v225/v253/v255/v263 non-goals, ADR-0009 |
