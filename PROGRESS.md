...
Last updated: 2026-07-09 (v461 entity locomotion polish)
...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v461 — entity locomotion polish |
| **Next slice** | v462 TBD |
...
| Combat / movement feel | Broader shared-rules movement-speed or acceleration retuning remains deferred after v461's presentation-only locomotion polish; revisit only if hero/monster traversal still needs heavier gameplay-owned pacing after more visual playtime. | v461 non-goal |
