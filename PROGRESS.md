...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v239 — mercenary stats card |
| **Active branch** | `main` |
| **CI gate** | Focused v239 verification green on 2026-06-17; batch `make ci` pending after selected v233-v240 `$autoloop` queue |
| **Next slice** | v240 — boss portrait panel |
