...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v290 — blacksmith armor recipe |
| **Active branch** | `main` |
| **CI gate** | v290 focused gates green on 2026-06-19 (`go test ./internal/http -run Blacksmith`, `test_blacksmith_panel.gd`, `bot-client scenario=70_blacksmith_armor_recipe`, `make maintainability`); full autoloop-batch `make ci` pending after selected queue |
| **Next slice** | v291 — unique skill modifier item |
