...
| Field | Value |
|-------|-------|
Last updated: 2026-07-04 (v441 attack animations ranged)
...
| Field | Value |
|-------|-------|
| **Latest completed slice** | v441 — attack animations ranged |
| **CI gate** | 2026-07-04 — final `make ci` pending (autoloop batch) |
| **Next slice** | TBD |
