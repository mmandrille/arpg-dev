...
const STEP_TYPES_WAIT := [
	...
	"wait_movement_visual_smoothing", "wait_command_retarget_grace", "wait_melee_lunge",
...
const STEP_TYPES_ASSERT := [
	...
	"assert_entity_reaction", "assert_movement_visual_smoothing", "assert_command_retarget_grace", "assert_melee_lunge",
