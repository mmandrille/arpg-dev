...
func _run() -> void:
	...
	_assert_true("manifest-loaded skills include lightning", ids.has("lightning"))
	...
	_assert_eq("lightning kind from manifest-listed rules", str(SkillRulesLoaderScript.skill_definition("lightning").get("kind", "")), "chain_projectile_attack")
	...
	_assert_eq("arcane barrage prerequisite", str(((SkillRulesLoaderScript.skill_definition("arcane_barrage").get("requirements", {}).get("skills", []) as Array)[0] as Dictionary).get("skill_id", "")), "lightning")
	...
	_assert_eq("snipe kind from manifest-listed rules", str(SkillRulesLoaderScript.skill_definition("snipe").get("kind", "")), "projectile_attack")
	_assert_eq("snipe prerequisite", str(((SkillRulesLoaderScript.skill_definition("snipe").get("requirements", {}).get("skills", []) as Array)[0] as Dictionary).get("skill_id", "")), "piercing_shot")
	...
	_assert_eq("lightning presentation label", str(SkillRulesLoaderScript.skill_presentation("lightning").get("icon", {}).get("label", "")), "L")
	...
	_assert_eq("snipe presentation label", str(SkillRulesLoaderScript.skill_presentation("snipe").get("icon", {}).get("label", "")), "S")
	_assert_eq("snipe projectile presentation", str(SkillRulesLoaderScript.skill_presentation("snipe").get("projectile_visual", "")), "piercing_shot_projectile")
