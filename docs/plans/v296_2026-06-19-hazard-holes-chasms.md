...
Architecture: Reuse the authoritative layout obstacle stream from v295 with a new additive `hole` kind. Server movement/pathfinding treats holes as grounded blockers, while projectile and fog/LOS checks remain wall-only. Client rendering branches by kind to draw holes as flat dark chasms.
...
Baseline: v295 `water-obstacles-foundation` is committed on `codex/world-detail-navigation` as `d8a69cb8`.
...
Asset/plugin decision: reject external assets, imported chasm art, shader plugins, and Godot addons. Borrow the v295 obstacle-kind foundation, wall renderer branch pattern, deterministic texture factory, and reachable obstacle bot scenario.
...
| Add | `docs/as-built/v296_hazard-holes-chasms.md` | Record shipped behavior and proof. |
...
Files:
- Modify: `docs/specs/v296_spec-hazard-holes-chasms.md`
- Modify: `docs/plans/v296_2026-06-19-hazard-holes-chasms.md`
- Add: `docs/as-built/v296_hazard-holes-chasms.md`
