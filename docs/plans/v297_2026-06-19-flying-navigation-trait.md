# v297 Plan - Flying Navigation Trait
...
Baseline: v296 `hazard-holes-chasms` is committed on `codex/world-detail-navigation` as `0bfebc71`.
...
Asset/plugin decision: reject external assets, imported bat/flying VFX, shaders, and Godot addons. Borrow existing bat presentation, the v295/v296 obstacle-kind layout/rendering path, and existing compact world/bot lab patterns.
...
| Modify | `docs/specs/v297_spec-flying-navigation-trait.md` | Mark complete after proof. |
| Modify | `docs/plans/v297_2026-06-19-flying-navigation-trait.md` | Track execution checkboxes. |
| Add | `docs/as-built/v297_flying-navigation-trait.md` | Record shipped behavior and proof. |
...
Files:
- Modify: `docs/specs/v297_spec-flying-navigation-trait.md`
- Modify: `docs/plans/v297_2026-06-19-flying-navigation-trait.md`
- Add: `docs/as-built/v297_flying-navigation-trait.md`
