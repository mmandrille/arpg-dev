# v298 Plan - Barbarian Leap Obstacle Crossing
...
Baseline: v297 `flying-navigation-trait` is committed on `codex/world-detail-navigation` as `33aab019`.
...
| Modify | `docs/specs/v298_spec-barbarian-leap-obstacle-crossing.md` | Mark complete after proof. |
| Modify | `docs/plans/v298_2026-06-19-barbarian-leap-obstacle-crossing.md` | Track execution checkboxes. |
| Add | `docs/as-built/v298_barbarian-leap-obstacle-crossing.md` | Record shipped behavior and proof. |
...
Files:
- Modify: `docs/specs/v298_spec-barbarian-leap-obstacle-crossing.md`
- Modify: `docs/plans/v298_2026-06-19-barbarian-leap-obstacle-crossing.md`
- Add: `docs/as-built/v298_barbarian-leap-obstacle-crossing.md`
