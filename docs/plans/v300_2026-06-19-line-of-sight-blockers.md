# v300 Plan - Line-of-Sight Blockers
...
Baseline: v299 `obstacle-variety-pack` is committed on `codex/world-detail-navigation` as `6c81a4c9`.
...
Spec OK. It builds on v299, keeps server authority for visibility, lists the shared schema change, includes concrete preset and bot proof, and keeps movement/projectile/flying/Leap behavior out of scope. No blocking questions.
...
| Modify | `docs/specs/v300_spec-line-of-sight-blockers.md` | Mark complete after proof. |
| Modify | `docs/plans/v300_2026-06-19-line-of-sight-blockers.md` | Track execution checkboxes. |
| Add | `docs/as-built/v300_line-of-sight-blockers.md` | Record shipped behavior and proof. |
...
- [x] Step 3.4: Update v299 obstacle-variety assertions to reflect rock/column now block LOS while rubble does not.
...
Files:
- Modify: `docs/specs/v300_spec-line-of-sight-blockers.md`
- Modify: `docs/plans/v300_2026-06-19-line-of-sight-blockers.md`
- Add: `docs/as-built/v300_line-of-sight-blockers.md`
