# v301 Plan - Wall/Floor Shader Polish
...
Baseline: v300 `line-of-sight-blockers` is committed on `codex/world-detail-navigation` as `a52e036b`.

Autoloop note: v301 is the final selected World Detail/Navigation slice. The selected-batch
...
| Modify | `docs/specs/v301_spec-wall-floor-shader-polish.md` | Mark complete after proof. |
| Modify | `docs/plans/v301_2026-06-19-wall-floor-shader-polish.md` | Track execution checkboxes. |
| Add | `docs/as-built/v301_wall-floor-shader-polish.md` | Record shipped behavior and proof. |
...
Files:
- Modify: `docs/specs/v301_spec-wall-floor-shader-polish.md`
- Modify: `docs/plans/v301_2026-06-19-wall-floor-shader-polish.md`
- Add: `docs/as-built/v301_wall-floor-shader-polish.md`
