# v306 Plan - Obstacle Variety Pack
...
Baseline: v305 `barbarian-leap-obstacle-crossing` is committed on `codex/world-detail-navigation` as `d123dd05`.
...
| Modify | `docs/specs/v306_spec-obstacle-variety-pack.md` | Mark complete after proof. |
| Modify | `docs/plans/v306_2026-06-19-obstacle-variety-pack.md` | Track execution checkboxes. |
| Add | `docs/as-built/v306_obstacle-variety-pack.md` | Record shipped behavior and proof. |
| Modify | `docs/progress/slice-lifecycle.md` | Add v306 lifecycle row. |
...
Files:
- Modify: `docs/specs/v306_spec-obstacle-variety-pack.md`
- Modify: `docs/plans/v306_2026-06-19-obstacle-variety-pack.md`
- Add: `docs/as-built/v306_obstacle-variety-pack.md`
