...
This slice builds directly on v295's obstacle-kind foundation and keeps holes as terrain blockers
...
- Docs:
  - `docs/plans/v296_2026-06-19-hazard-holes-chasms.md`
  - `docs/as-built/v296_hazard-holes-chasms.md`
...
addons. Borrow the v295 obstacle-kind layout, deterministic generator validation, and code-native
