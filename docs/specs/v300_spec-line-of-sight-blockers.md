# v300 Spec - Line-of-Sight Blockers
...
shadow masks behind tall blockers. This makes the v299 rock/column obstacle work affect gameplay
perception while keeping water, holes, and low rubble visible-through terrain.

This builds on v295-v299's obstacle-kind foundation and the existing fog-of-war wall/door
...
- Docs:
  - `docs/plans/v300_2026-06-19-line-of-sight-blockers.md`
  - `docs/as-built/v300_line-of-sight-blockers.md`
