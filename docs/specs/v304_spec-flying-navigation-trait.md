# v304 Spec - Flying Navigation Trait
...
This slice builds on v302 water and v303 holes so later slices can add player class mobility
...
- Docs:
  - `docs/plans/v304_2026-06-19-flying-navigation-trait.md`
  - `docs/as-built/v304_flying-navigation-trait.md`
...
the existing bat monster definition/model, the v302/v303 obstacle-kind rendering path, and the
