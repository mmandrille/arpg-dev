# v305 Spec - Barbarian Leap Obstacle Crossing
...
This builds on v302 water, v303 holes, and v304 obstacle-kind plumbing. Leap becomes the first player
...
- Docs:
  - `docs/plans/v305_2026-06-19-barbarian-leap-obstacle-crossing.md`
  - `docs/as-built/v305_barbarian-leap-obstacle-crossing.md`
...
event path and the existing water/hole rendering introduced by v302-v304.
