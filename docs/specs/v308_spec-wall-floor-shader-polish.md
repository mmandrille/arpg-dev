# v308 Spec - Wall/Floor Shader Polish
...
v302-v307 gameplay obstacle work with presentation polish only.
...
- Docs:
  - `docs/plans/v308_2026-06-19-wall-floor-shader-polish.md`
  - `docs/as-built/v308_wall-floor-shader-polish.md`
...
Final selected-batch proof after v308 commits:
