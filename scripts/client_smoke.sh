...
run_gate "GDScript class body tint test" "[gdtest] PASS: test_class_body_tint" res://tests/test_class_body_tint.gd
...
run_gate "GDScript blacksmith upgrade chance test" "[gdtest] PASS: test_blacksmith_upgrade_chance" res://tests/test_blacksmith_upgrade_chance.gd
...
run_gate "GDScript projectile flight presentation test" "[gdtest] PASS: test_projectile_flight_presentation" res://tests/test_projectile_flight_presentation.gd
