...
for name in next spec plan execute finish review showme autoloop; do
...
echo "Invoke with \$next / \$spec / \$plan / \$execute / \$finish / \$review / \$showme / \$autoloop or ask per AGENTS.md slash commands."
