...
for name in next spec plan execute finish review showme autoloop refactor; do
...
echo "Invoke with \$next / \$spec / \$plan / \$execute / \$finish / \$review / \$showme / \$autoloop / \$refactor or ask per AGENTS.md slash commands."
