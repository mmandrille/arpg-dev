...
var inputHandlers = map[string]inputHandlerFunc{
	...
	"channel_skill_intent":            (*Sim).handleChannelSkill,
	...
	"bishop_debug_drop_respec_badge_intent": (*Sim).handleBishopDebugDropRespecBadge,
	"bishop_debug_drop_resurrection_badge_intent": (*Sim).handleBishopDebugDropResurrectionBadge,
...
func (s *Sim) handleCastSkill(in Input, res *TickResult) {
	...
	case "passive_execute", "passive_stat_bonus":
