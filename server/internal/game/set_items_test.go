...
func TestSecondSetPackagePayloadsAndBonuses(t *testing.T) {
	...
	if payload.Rarity != "set" || payload.DisplayName != "Stormrunner Covenant Bow" || payload.ItemTemplateID != "bow" {
...
func TestWayfarersAccordSetPayloadsAndBonuses(t *testing.T) {
	...
	if payload.Rarity != "set" || payload.DisplayName != "Wayfarer's Accord Pendant" || payload.ItemTemplateID != "amulet" {
