...
func (f *fakeRepo) UpgradeAccountStashItem(context.Context, string, string, int, int, map[string]struct{}) (store.AccountStashItem, int, error) {
	return store.AccountStashItem{}, 0, nil
}
