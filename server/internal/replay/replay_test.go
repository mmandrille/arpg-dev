...
func (f *fakeRepo) UpgradeAccountStashItemWithShard(context.Context, string, string, string, int, int, int, int, int, int, map[string]struct{}, game.ItemUpgradeOptions, string) (store.AccountStashItem, int, int, int, bool, error) {
...
func (f *fakeRepo) RenewInventoryItem(context.Context, string, string, string, int, int, map[string]struct{}, func(json.RawMessage) ([]byte, error), string) (store.CharacterItemInstance, int, int, int, error) {
