...
type CharacterProgressionRepo interface {
	...
	UpgradeAccountStashItem(ctx context.Context, accountID, stashItemID string, baseCostGold, costGrowthPerLevel, maxLevel, successChancePercent, successRoll int, eligibleItemDefs map[string]struct{}) (AccountStashItem, int, int, bool, error)
	UpgradeAccountStashItemWithWallet(ctx context.Context, accountID, characterID, stashItemID string, baseCostGold, costGrowthPerLevel, maxLevel, successChancePercent, successRoll int, eligibleItemDefs map[string]struct{}) (AccountStashItem, int, int, int, bool, error)
