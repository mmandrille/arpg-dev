...
func TestDeleteStaleEmptySessions(t *testing.T) {
	...
	if err := s.CreateSessionStartSnapshot(ctx, oldEmpty.ID, oldEmpty.AccountID, oldEmpty.CharacterID, nil, nil, nil, CharacterSkillBindings{}, nil, nil, AccountStashGold{AccountID: oldEmpty.AccountID}, nil, CharacterProgression{
