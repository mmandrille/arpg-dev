...
def main() -> int:
    ...
    parser.add_argument("--focus", choices=["gear", "inventory", "skills", "shop", "market-board", "market-publish", "market-offer", "character-menu", "join-menu", "hud", "stairs", "chests", "vendors", "monsters", "heal-rain", "town"], default="gear")
