...
def main() -> int:
    ...
    parser.add_argument("--focus", choices=["gear", "classes", "floor-item", "inventory", "corpse", "corpse-inventory", "skills", "shop", "bishop", "market-board", "market-publish", "market-offer", "character-menu", "join-menu", "hud", "stairs", "chests", "vendors", "monsters", "heal-rain", "town"], default="gear")
    ...
    if args.focus == "corpse-inventory" and (args.width, args.height) == (640, 480):
    ...
    if args.focus == "market-board" and (args.width, args.height) == (640, 480):
        width, height = 960, 640
    ...
    if args.focus == "stairs" and (args.width, args.height) == (640, 480):
        width, height = 960, 640
    if args.focus == "chests" and (args.width, args.height) == (640, 480):
        width, height = 960, 640
    if args.focus == "vendors" and (args.width, args.height) == (640, 480):
        width, height = 960, 640
    if args.focus == "monsters" and (args.width, args.height) == (640, 480):
        width, height = 1120, 640
