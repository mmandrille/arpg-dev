...
def test_hero_rig_sources_include_all_class_models():
    # barbarian is generated by gen_glb.py (_full_humanoid_glb) with proper per-bone
    # vertex weights and is excluded from HEROES so gen-assets does not overwrite it.
    assert set(HEROES.keys()) == {"paladin", "rogue", "ranger", "sorcerer"}
...
def test_barbarian_runtime_glb_has_required_bones():
    # barbarian.glb is generated by gen_glb.py, not rig_hero_glbs.py
    runtime = ROOT / "client/assets/characters/barbarian/barbarian.glb"
